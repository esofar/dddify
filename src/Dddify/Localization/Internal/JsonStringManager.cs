...
public class JsonStringManager(string resourcesPath, string resourceName)
{
    ...
    private static Dictionary<string, string> LoadJsonResources(string filePath)
    {
        ...
        if (File.Exists(filePath))
        {
            ...
            if (!string.IsNullOrWhiteSpace(content))
            {
                ...
                resources = JsonSerializer.Deserialize<Dictionary<string, string>>(content.Trim(), options)!;
